...
add_action( 'wp_enqueue_scripts', function() {
  ...
  if ( $is_quiz ) {
    wp_enqueue_script(
      'qa-marked',
      QA_URL . 'assets/js/marked.min.js',
      [],
      filemtime( QA_DIR . 'assets/js/marked.min.js' ),
      true
    );
    wp_enqueue_script(
      'qa-dompurify',
      QA_URL . 'assets/js/purify.min.js',
      [],
      filemtime( QA_DIR . 'assets/js/purify.min.js' ),
      true
    );
    wp_enqueue_script(
      'qa-quiz-widget',
      QA_URL . 'assets/js/quiz-widget.js',
      [ 'wp-element', 'qa-marked', 'qa-dompurify' ],
    ...
    wp_localize_script( 'qa-quiz-widget', 'QA_Assist_Quiz_Settings', [
      ...
      'publicToken'    => '',
      'assets'         => [
        'topbarIcon'    => QA_URL . 'assets/img/farhat-topbar-icon.png',
        'topbarAvatar'  => QA_URL . 'assets/img/farhat-topbar-avatar.png',
        'premiumRobot'  => QA_URL . 'assets/img/farhat-robot-premium.png',
      ],
    ] );
  }
